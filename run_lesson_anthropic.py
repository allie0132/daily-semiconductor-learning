"""Temporary wrapper: runs generate_lesson.py using Anthropic API (Bearer auth) instead of OpenRouter."""
import json
import os
import re
import time
...
print("Used model: claude-haiku-4-5-20251001")
